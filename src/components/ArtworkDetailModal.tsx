...
import { Calendar, User, Palette, Download } from 'lucide-react'
...
export default function ArtworkDetailModal({ isOpen, onClose, artworkId }: ArtworkDetailModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto mx-4 sm:mx-auto">
        <DialogHeader>
          <DialogTitle className="text-xl sm:text-2xl">Artwork Details</DialogTitle>
        </DialogHeader>
